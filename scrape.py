...
def scrape():
    ...
    mars = {'News_Title' : news_title, 'News_Paragraph' : news_p, 'Mars_Photo' : featured_image_url, 'Mars_Weather' : mars_weather, 'Mars_Overview' : html_ov, 'Mars_Comparison' : html_comp, 'Hemisphere_Photos' : hemisphere_image_urls}
